...
public class Usa_Fragment_Steak extends Fragment {
...
//	my_layout.addView(myrating);
	...
	View view = inflater.inflate(R.layout.usa_fragment_steak, container,
				false);
		...
		final View layout = inflater.inflate(R.layout.usa_steak1_contents,
		...
		steak_minus_button1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (steak_count_value1 != 0) {
					steak_count_value1--;
					steak_count_text1.setText("" + steak_count_value1);
					Usa_Fragment_Steak.steak_numInt1 = steak_count_value1;
					Usa_Fragment_Steak.steak_total1 = (29000 * Usa_Fragment_Steak.steak_numInt1);
					Usa_Fragment_Steak.steak_final_total = Usa_Fragment_Steak.steak_total1
							+ Usa_Fragment_Steak.steak_total2
							+ Usa_Fragment_Steak.steak_total3
							+ Usa_Fragment_Steak.steak_total4;
					...
					Korean_Activity.adapter.add(new CData3(
							...
							Usa_Fragment_Steak.steak1_name,
							Usa_Fragment_Steak.steak_numInt1,
							Usa_Fragment_Steak.steak_total1));
					if (steak_count_value1 == 0) {
		...
		steak_minus_button2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (steak_count_value2 != 0) {
					steak_count_value2--;
					steak_count_text2.setText("" + steak_count_value2);
					Usa_Fragment_Steak.steak_numInt2 = steak_count_value2;
					Usa_Fragment_Steak.steak_total2 = (34500 * Usa_Fragment_Steak.steak_numInt2);
					Usa_Fragment_Steak.steak_final_total = Usa_Fragment_Steak.steak_total1
							+ Usa_Fragment_Steak.steak_total2
							+ Usa_Fragment_Steak.steak_total3
							+ Usa_Fragment_Steak.steak_total4;
					...
					Korean_Activity.adapter.add(new CData3(
							Korean_Activity.context,
							Usa_Fragment_Steak.steak2_name,
							Usa_Fragment_Steak.steak_numInt2,
							Usa_Fragment_Steak.steak_total2));
					if (steak_count_value2 == 0) {
		...
		steak_minus_button3.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (steak_count_value3 != 0) {
					steak_count_value3--;
					steak_count_text3.setText("" + steak_count_value3);
					Usa_Fragment_Steak.steak_numInt3 = steak_count_value3;
					Usa_Fragment_Steak.steak_total3 = (38000 * Usa_Fragment_Steak.steak_numInt3);
					Usa_Fragment_Steak.steak_final_total = Usa_Fragment_Steak.steak_total1
							+ Usa_Fragment_Steak.steak_total2
							+ Usa_Fragment_Steak.steak_total3
							+ Usa_Fragment_Steak.steak_total4;
					...
					Korean_Activity.adapter.add(new CData3(
							Korean_Activity.context,
							Usa_Fragment_Steak.steak3_name,
							Usa_Fragment_Steak.steak_numInt3,
							Usa_Fragment_Steak.steak_total3));
					if (steak_count_value3 == 0) {
		...
		steak_minus_button4.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (steak_count_value4 != 0) {
					steak_count_value4--;
					steak_count_text4.setText("" + steak_count_value4);
					Usa_Fragment_Steak.steak_numInt4 = steak_count_value4;
					Usa_Fragment_Steak.steak_total4 = (36500 * Usa_Fragment_Steak.steak_numInt4);
					Usa_Fragment_Steak.steak_final_total = Usa_Fragment_Steak.steak_total1
							+ Usa_Fragment_Steak.steak_total2
							+ Usa_Fragment_Steak.steak_total3
							+ Usa_Fragment_Steak.steak_total4;
					...
					Korean_Activity.adapter.add(new CData3(
							Korean_Activity.context,
							Usa_Fragment_Steak.steak4_name,
							Usa_Fragment_Steak.steak_numInt4,
							Usa_Fragment_Steak.steak_total4));
					if (steak_count_value4 == 0) {
			...
			public void onClick(View v) {
				...
				*/
				...
				AlertDialog ad = new AlertDialog.Builder(getActivity())
						.create();
				ad.setTitle("Specification"); // 팝업창 타이틀바
				ad.setView(layout);
				//ad.setView(layout);
				// ad.setMessage("FinessShot"); //팝업창 내용
				ad.setButton(getActivity().getString(R.string.usa_exit_name),
